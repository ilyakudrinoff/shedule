...
urlpatterns = [
    ...
    path('<contact_pk>', views.contact_card, name='contact'),
    ...
    path('<contact_pk>/meets/<meet_pk>/edit', views.meet_edit, name='meet_edit'),
    path('<contact_pk>/relationships', views.relationships, name='relationships'),
    path('<contact_pk>/relationship/create', views.relationship_create, name='relationship_create'),
    path('<contact_pk>/relationship/<relationship_pk>/edit', views.relationship_edit, name='relationship_edit'),
    path('<contact_pk>/facts', views.facts, name='facts'),
    path('<contact_pk>/facts/create', views.fact_create, name='fact_create'),
    path('<contact_pk>/facts/<fact_pk>/edit', views.fact_edit, name='fact_edit'),
]
